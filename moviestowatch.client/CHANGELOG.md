...
- Create Angular project with ng: `ng new moviestowatch.client --defaults --skip-install --skip-git --no-standalone `.
...
- Create project file (`moviestowatch.client.esproj`).
